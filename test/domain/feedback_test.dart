...
void main() {
  ...
  test(
    ...
    () {
      ...
      game = engine.configureRound(game, 10, 3);
      ...
      expect(game.roundConfigured, isFalse);
  ...
  test(
    ...
    () {
      game = engine.configureRound(game, 2, 3);
      final before = game;
  ...
  test(
    ...
    () {
      game = engine.configureRound(game, 10, 5);
      for (final p in game.players) {
  ...
  test('mid-round top-up, reorder, configuration and finish are blocked', () {
    ...
    expect(
      () => engine.configureRound(game, 1, 1),
      throwsA(isA<GameRuleException>()),
    );
